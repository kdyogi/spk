...
@section('now', 'Default Alter')

@section('link-active-view', 'active')
@section('link-active-alter', 'active')
    ...
    <div class="container-fluid mt-2">
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        @foreach ($alternatif as $alternatif)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    {{-- @if ($alternatif->nilai->where('user_id', Auth::user()->id == null))
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#nilai{{$alternatif->id}}"><i class="fas fa-edit mr-3 fa-1x"></i>Nilai</button>
                                    @else
                                        @if ($alternatif['id'] == $nilai['alternatif_id'])
                                        {{Auth::user()->level_user == 'Admin' ? '|' : ''}} <span class="icon-checkmark-circle2 mr-3 icon-2x"></span>
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#dataNilai{{$nilai->alternatif_id}}"><i class="fas fa-edit mr-3 fa-1x"></i>Nilai</button>
                                        @else
                            ...
                            <div class="modal fade" id="nilai{{$alternatif->id}}" role="dialog">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Tambah Nilai Alternatif ({{$alternatif->nama_alternatif}})</h4>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                ...
                {{-- Modal Info Penilaian --}}
                <div class="modal fade" id="penilaian" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Info Penilaian</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <ol>
