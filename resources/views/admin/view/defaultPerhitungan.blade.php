...
{{-- @section('link-active-perhitungan-default', 'active')
@section('link-active-perhitungan-default', 'active')
@section('menu-perhitungan-default', 'nav-item-expanded nav-item-open') --}}
@section('link-active-perhitungan-default', 'active')
                    ...
                    <tbody>
                        @foreach ($data as $al)
                            <tr>
                                ...
                                @foreach ($al->nilai->where('user_id', Auth::user()->id) as $nilai)
