...
(function (h) {
    ...
    function nb(a) {
        ...
        for (
            var f = a.sDom.split(""), g, j, i, m, l, q, k = 0; k < f.length; k++
        ) {
            g = null;
            j = f[k];
            if ("<" == j) {
    ...
    function xb(a, b, c, d, e, f) {
        if ("" !== b) {
            for (
                var g = [], j = a.aiDisplay, d = Pa(b, d, e, f), e = 0; e < j.length; e++
            )
                    ...
                    0 < D(g, "_details").length &&
                        (f.on("draw.dt.DT_details", function (a, b) {
                            ...
                            f.on("column-visibility.dt.DT_details", function (
                                ...
                                if (e === b)
                                    for (
                                        var c, d = V(b), f = 0, h = g.length; f < h; f++
                                    )
                                        (c = g[f]),
                                        c._details &&
                                        c._details
                ...
                f = function (a, b) {
                    if (h.isArray(a) || a instanceof h)
                        ...
                        ((c = h("<tr><td/></tr>").addClass(b)),
                            (h("td", c).addClass(b).html(a)[0].colSpan = V(
                                d
                            )),
                            e.push(c[0]));
                };
